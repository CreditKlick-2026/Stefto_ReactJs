...
const TravelHospitalityAndCargo = () => {
  return (
    <div className="container" style={{ padding: '8rem 2rem 4rem' }}>
      <h1>Travel Hospitality And Cargo</h1>
      <p style={{ marginTop: '2rem' }}>
        This page represents the migrated content for the "travel-hospitality-and-cargo" section from the legacy website.
      </p>
...
export default TravelHospitalityAndCargo;
